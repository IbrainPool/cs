 ...
 <main>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('alta')); ?>">Alta de producto</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('productos.index')); ?>">Consulta de Producto</a>
          </li>
...
<?php /**PATH C:\laragon\www\Examen\resources\views/layouts.blade.php ENDPATH**/ ?>